...
% It has been suggested that, in the human brain, there exist shared multi-sensorial representations of objects. 
% This provides robustness when one or more senses are absent or unreliable. 
